    ...
    return (
        <>
            <form>
                ...
                >
                    <Legend className="text-4xl font-bold transition-all duration-500">
                        Sign Up
                    </Legend>
                    <Field>
                        <Label className="block data-[disabled]:text-gray-200 transition-all duration-500">
                            Username
                        </Label>
                        <Input
                            className="mt-1 block bg-red-950 rounded disabled:text-gray-200 disabled:bg-rose-950 transition-all duration-500"
                            name="username"
                        />
                    ...
                    <Field>
                        ...
                        <Select
                            className="mt-1 block bg-red-950 rounded p-1"
                            name="account-type"
                        >
            ...
            {status === "missing username and/or password" && (
