        ...
        <>
                ...
                return (
                    <Card id={"card-" + cardIndex}>
                        ...
                        <div>
                            ...
                            <EditText
                                editable={editor}
                                id={"card-" + cardIndex + "-post"}
                            >
                                {card.post}
                            </EditText>
                        </div>
                        {card.interactive &&
                            card.interactive.type === "code-editor" && (
                        ...
                        {editor && (
                            <Button
                                ...
                                onClick={(e) => {
                                    ...
                                    if (
                                        !json.cards[+e.target.id.slice(12)]
                                            .interactive
                                    ) {
                                        json.cards[
                                            +e.target.id.slice(12)
                                        ].interactive = {
                                            type: "code-editor",
                                            lang: "js",
                                            features: ["console"],
            ...
            {!editor && (
                <Button
                    ...
                    onClick={() => {
                        fetch(
                            "//localhost:8081/students/me/completions/" +
                                lessonID,
                            {
                                method: "PUT",
                                headers: {
